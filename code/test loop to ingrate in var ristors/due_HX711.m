...
%**************************************************************************
classdef due_HX711 < matlabshared.addon.LibraryBase
    ...
    properties(Access = protected, Constant = true)
        LibraryName = 'dueHX711/due_HX711'
        DependentLibraries = {}
        LibraryHeaderFiles = 'due_HX711/due_HX711.h'
        CppHeaderFile = fullfile(arduinoio.FilePath(mfilename('fullpath')), 'src', 'due_HX711.h')
        CppClassName = 'due_HX711'
    end
    
    methods(Hidden, Access = public)
        % CONSTRUCTOR: LoadCell = addon(a,'dueHX711/due_HX711',...
        %   'Pins',{'D2','D3'},'Gain',128,'Interrupt',true);
        function obj = due_HX711(parentObj,varargin)
