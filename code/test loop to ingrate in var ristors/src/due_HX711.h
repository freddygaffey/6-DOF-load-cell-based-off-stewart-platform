...
class due_HX711 : public LibraryBase
{
    public:
        due_HX711(MWArduinoClass& a)
        {
            libName = "dueHX711/due_HX711";
    ...
    void commandHandler(byte cmdID, byte* dataIn, unsigned int payloadSize)
    {
        switch (cmdID){
            ...
            case READ:{
                ...
                /* The following code is not elegant or the most efficient
                 * but it's easy to understand and also preparatory for
